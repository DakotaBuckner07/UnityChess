...
public class BoardManager : MonoBehaviour {
  ...
  public void ChessType(int type) {
    switch (type) {
      case 1:
        isNormalChess = true;
        break;
  ...
  private void SpawnAllChessmans960() {
    ...
    /////// White ///////
    List<int> backrow = new List<int>() { 0, 0, 0, 0, 0, 0, 0, 0 };
    int Bishop1Place = UnityEngine.Random.Range(0, 4) * 2;
    backrow[Bishop1Place] = 1;
    int Bishop2Place = UnityEngine.Random.Range(0, 4) * 2 + 1;
    backrow[Bishop2Place] = 1;

    int Knight1Place = UnityEngine.Random.Range(0, 8);
    do {
      if(backrow[Knight1Place] != 1) {
        backrow[Knight1Place] = 1;
        break;
      }
      Knight1Place = UnityEngine.Random.Range(0, 8);
    } while (true);

    int Knight2Place = UnityEngine.Random.Range(0, 8);
    do { 
      if (backrow[Knight2Place] != 1) {
        backrow[Knight2Place] = 1;
        break;
      }
      Knight2Place = UnityEngine.Random.Range(0, 8);
    } while (true);

    int QueenPlace = UnityEngine.Random.Range(0, 8);
    do { 
      if (backrow[QueenPlace] != 1) {
        backrow[QueenPlace] = 1;
        break;
      }
      QueenPlace = UnityEngine.Random.Range(0, 8);
    } while (true);

    int Rook1Place = backrow.IndexOf(0);
    backrow[Rook1Place] = 1;
    int  KingPlace = backrow.IndexOf(0);
    backrow[KingPlace] = 1;
    int Rook2Place = backrow.IndexOf(0);
    backrow[Rook2Place] = 1;
